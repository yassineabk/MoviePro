...
import com.example.filmos.MainActivity
import com.example.filmos.MovieModelClass
import com.example.filmos.R
import kotlinx.android.synthetic.main.item_row.view.*

class ItemAdapter(val context: Context, val items: ArrayList<MovieModelClass>) :
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.tvReleaseDate.text = item.release
        holder.tvNbrS.text = item.nbrS.toString()
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        val tvDirector: TextView = view.tvDirector
        val tvReleaseDate: TextView = view.tvReleaseDate
        val tvNbrS: TextView = view.tvNbrS
